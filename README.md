...
Como parte de la práctica del módulo de *devops* del [Startup Engineering Master de KeepCoding](https://keepcoding.io/es/keepcodingstartupengineeringmasterbootcamp/), este proyecto está desplegado en la URL del siguiente [link](https://nodepop.danruicar.com/). La aplicación sirve un archivo estático a través de esta [URL](https://nodepop.danruicar.com/stylesheets/style.css).
